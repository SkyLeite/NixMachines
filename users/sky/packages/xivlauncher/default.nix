...
, glib, gnutls, aria2, steam-run, copyDesktopItems, makeDesktopItem
, useSteamRun ? true, ... }:

let rev = "6246fde6b54f8c7e340057fe2d940287c437153f";
in buildDotnetModule rec {
  ...
  nugetDeps =
    ./deps.nix; # File generated with `nuget-to-nix path/to/src > deps.nix`

  dotnetFlags = [ "--runtime linux-x64" "-p:BuildHash=${rev}" ];
